 ...
 */
public class UserRegistrationTask extends AsyncTask<String,Void,String> implements Constants {

    private String TAG=UserRegistrationTask.class.getSimpleName();
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        progress = new ProgressDialog(context,context.getResources().getString(R.string.login_progress_message));
    ...
    protected String doInBackground(String... param) {
        try
        {
            ...
            params.put(Constants.login, param[0]);
            params.put(Constants.password, param[1]);
    ...
    protected void onPostExecute(String result) {
        ...
        asyncInterface.RegistrationResponse(result);
    }
